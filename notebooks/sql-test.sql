...
/*markdown
### Write a query to find customers who have made consecutive purchases. For each such customer, provide their name, the order dates of the consecutive purchases, and the number of days between these orders.
*/
